...
class FinalizedOrderSerializer(TokenMixin, serializers.Serializer):
    ...
    def validate(self, data):
        ...
        order_id = order_data.get('order_token')
        ...
        try:
            ...
            raise serializers.ValidationError("This isn't a valid order for this user")

        payment_method_nonce = data.get('payment_method_nonce')
        if not payment_method_nonce:
            raise serializers.ValidationError("This isn't a valid nonce")
